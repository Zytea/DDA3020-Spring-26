...
| **x1**   | $0.0000713624 \approx 0$       |
| -------- | ------------------------------ |
| **x2**   | $0.0000000000 \approx 0$       |
| **f(x)** | $5.092589940836e-09 \approx 0$ |

### (b)

<img src="C:\Users\Zytea\Downloads\DDA3020-HW1-update\q2_1.png" alt="q2_1" style="zoom: 33%;" />
...
<img src="C:\Users\Zytea\Downloads\DDA3020-HW1-update\q2_2_noreg.png" alt="q2_2_noreg" style="zoom: 33%;" />

### (b) L2

| $\lambda$ | **Train acc** | **Test acc** | n(zero weights) |
| --------- | ------------- | ------------ | --------------- |
...
- Model Performance: 
  - Both L1 and L2 regularization with $\lambda$ values of 0.01 and 0.1 achieved perfect test accuracy (1.0000) and high train accuracy (0.9750). 
...
- Sparsity:
  ...
  - In contrast, L2 regularization did not produce any near-zero weights across all $\lambda$ values, suggesting that L2 regularization does not encourage sparsity and rather tends to shrink weights.
